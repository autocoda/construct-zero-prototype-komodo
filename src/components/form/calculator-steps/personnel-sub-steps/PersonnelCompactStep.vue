<template>
  ...
  <div class="row">
    <div class="card bg-white p-4">
      <div class="row">
        <div class="col-12"><h2 class="fw-lighter text-uppercase">Personnel</h2></div>
        <div class="col-6">
        ...
        <div class="col-6">
          <div class="">Embodied <span class="fw-bold">--kg</span></div>
          <div class="">Transport <span class="fw-bold">--kg</span></div>
        </div>
        <div class="col-6">
          <div class="row">
